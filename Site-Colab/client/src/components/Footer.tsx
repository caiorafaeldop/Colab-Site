        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/70 leading-relaxed mb-6">
              Este é um site de demonstração para apresentar a estrutura e funcionalidades da plataforma.
            </p>
            
            {/* Social media removidas */}
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-center md:text-left">
            <p className="text-primary-foreground/70 text-sm">
              2025 Site Demo. Todos os direitos reservados.
            </p>
          </div>

          <div className="text-center md:text-right">
            <p className="text-primary-foreground/60 text-xs max-w-md">
              Este site tem caráter exclusivamente demonstrativo.
            </p>
          </div>
        </div>
      </div>
