              ...
              {articles.length > 0 && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2 flex flex-col h-full">
                    <Card 
                      className="card-shadow border-4 border-primary bg-white overflow-hidden group smooth-transition hover:scale-105 cursor-pointer flex-grow rounded-lg"
                  ...
                  <div className="space-y-6 h-full flex flex-col">
                    {articles.slice(1, 3).map((article, index) => (
                      <Card 
                        key={article.id} 
                        className="card-shadow border-4 border-primary bg-white overflow-hidden group smooth-transition hover:scale-105 cursor-pointer flex-1 rounded-lg"
            ...
            <div className="relative mb-8 md:hidden">
              ...
              >
                {articles.map((article, index) => (
                  <Card 
                    key={article.id} 
                    className="card-shadow border md:border-4 border-primary bg-white overflow-hidden group smooth-transition hover:scale-105 cursor-pointer flex-shrink-0 w-[calc(100vw-4rem)] mr-4 last:mr-0 rounded-lg"
                    onClick={() => navigate(`/artigo/${article.id}`)}
                  >
                    {/* Imagem do artigo */}
                    <div className="h-32 overflow-hidden">
